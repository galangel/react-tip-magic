...
<table>
  ...
  <tbody>
    <tr>
      <td><code>contentSeparator</code></td>
      <td>string</td>
      <td><code>';'</code></td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Tooltip content. Format: <code>"Main text; Shortcut"</code></td>
    </tr>
    <tr>
      <td><code>data-tip-separator</code></td>
...
```tsx
<nav>
  <a href="/home" data-tip="Home; ⌘1">Home</a>
  <a href="/search" data-tip="Search; ⌘K">Search</a>
  <a href="/settings" data-tip="Settings; ⌘,">Settings</a>
</nav>
```
...
<button data-tip="Save; ⌘S" onClick={handleSave}>Save</button>
```
