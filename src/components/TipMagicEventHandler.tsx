...
/**
 * Internal component that handles event delegation for tooltips
 *
 * This component sets up document-level event listeners for:
 * - Mouse hover (mouseover/mouseout)
 * - Focus management (focusin/focusout)
 * - Keyboard navigation (Escape to dismiss)
 *
 * It uses refs to avoid stale closure issues in timeouts and
 * properly manages show/hide delays for smooth transitions.
 */
export function TipMagicEventHandler() {
